...
Partial Class MasterMinimal
  ...
  Public Function GetCloseButton() As String
    If Request("mode") = "pop" Then
      GetCloseButton = "<a id=""btnCloseWindow"" href=""#"" class=""btn btn-primary hidden-print"" onclick=""window.close();""><i class=""fa fa-times"" aria-hidden=""True"" title=""X""></i></a>"
    Else
      GetCloseButton = ""
    End If
